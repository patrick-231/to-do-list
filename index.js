...
const todoTemplate = (todoTitle) => `
  <div class="todo-container text-gray-700 text-center flex justify-center align-center mt-2 w-3/5 m-auto">
    <div class="flex justify-between bg-yellow-100 shadow mb-2 w-full">
